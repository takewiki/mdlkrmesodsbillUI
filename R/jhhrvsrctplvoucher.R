...
#'
#' @examples
#' jhhrvsrctplvoucherUI()

jhhrvsrctplvoucherUI <- function(tabTitle ='凭证模版',
                    colTitles =c('操作区','显示区域'),
                    widthRates =c(4, 8),
                    func_left = buttontplvoucherUI_left,
                    func_right =buttontplvoucherUI_right
) {
...
#' @examples
#' buttonUI_left()
buttontplvoucherUI_left <- function() {
